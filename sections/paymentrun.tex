...
\centering
	\begin{tikzpicture}
		\begin{axis}[
				...
				height  = 6cm,
				ylabel={Anzahl distinkter Tupel},
				xlabel={Anzahl an Resultaten vom Zahllaufalgorithmus},
				ymin=0.0,
				xmin=0.0,
				ymax=210.0,
				xmax=240.0,
...
Tabelle \ref{tab:tupel2} zeigt exemplarisch diese fünf Tupel mit den größten Ergebnismengen, wovon zwei den ermittelten Eingabetupel in Tabelle \ref{tab:tupel} entsprechen.
...
Im Weiteren wird der deshalb der Einfluss der gewählten Obergrenze auf die Anzahl der ermittelten Eingabetupel mit mindestens einem Ergebnisdatensatz untersucht.
