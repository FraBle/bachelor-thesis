...
\centering
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{Verhältnis distinkter Eingabetupel zur Anzahl von Datensätzen in BSIK}
	\label{fig:tupelbsikverteilung}
\end{figure}

Tabelle \ref{tab:tupel2} zeigt exemplarisch diese fünf Tupel, wovon zwei den ermittelten Eingabetupel (siehe Tabelle \ref{tab:tupel}) entsprechen.
